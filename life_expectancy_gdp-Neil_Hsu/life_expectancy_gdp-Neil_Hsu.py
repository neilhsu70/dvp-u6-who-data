...
six_countries = ('Chile, China, Germany, Mexico, United States of America, Zimbabwe')
...
difference_in_two_bar_charts = 'It seems there is not too much correlation'
...
plt.show()
plt.savefig("violin_chart_LEABY.png")
...
visualized_data_answers = ('China changes the most in terms of GDP, Zimbabwe the most in life expectancy', 'For China, biggest change in GDP from 2007 to 2015, For Zimbabwe, biggest change in life expectancy from 2004-2015', 'least change in GDP is Zimbabwe', 'for most countries, GDP grows more than life expectancy', 'there is a correlation between GDP and life expectancy for most countries', 'there must be other factors for certain countries')
...
plt.savefig("scatter_plot_gdp&LEABY.png")
...
answers_for_8 = ('China moves the most on the X axis', 'Zimbabwe moves the most on the Y axis', 'not surprising considering my previous plots', 'this plot is very difficult to read and make conclusions')
...
answers_for_10 = ('Highest GDP country is USA, Lowest is Zimbabwe')
...
answers_for_10_2 = ('Hightest life expectancy is Germany, The Lowest is Zimbabwe')
...
further_context = ('Chinas government opened up their country for direct foreign investment a few years before this time period and this DFI started to pay off in large increased dividends in terms of GDP for the populace')
...
blog_post_anwers = ('Of course the histories and cultureal values of each country are reflected in the GDP & the life expectancy. Countries with the most to gain in terms of GDP, with appropriate governmental assistance, improve the most as well as life expectancy. Of course the biggest changes in GDP, China... was improved by governmental action. While the biggest changes in life expectancy, Zimbabwe, had such a depressed life expectancy at the beginning of this study that it had nowhere to go but up. Additional countries comporable to each country should be added to compare. While it would be difficult to find comporable countries at both extreme ends such as the USA in terms of wealth and Zimbabe in terms of lowered life expectancy, there are countries that have similar situations in different periods of history. Additional countries and a longer dataset would help. The bar plots and line plots are the easiest to read and make conclusions from. The scatter plots were difficult to read and hard to glean any useful information from.')
